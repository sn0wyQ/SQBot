...
ChatInviteLink::ChatInviteLink(const Json& chat_invite_link)
  : invite_link(SQBot::Utils::GetValue<std::string>(chat_invite_link, "invite_link")),
    ...
    expire_date(SQBot::Utils::GetValue<int32_t>(chat_invite_link, "expire_date")),
    member_limit(SQBot::Utils::GetValue<int32_t>(chat_invite_link, "member_limit")) {}
