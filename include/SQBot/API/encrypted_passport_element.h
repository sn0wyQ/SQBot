#ifndef INCLUDE_SQBOT_API_ENCRYPTED_PASSPORT_ELEMENT_H_
#define INCLUDE_SQBOT_API_ENCRYPTED_PASSPORT_ELEMENT_H_
...
#endif  // INCLUDE_SQBOT_API_ENCRYPTED_PASSPORT_ELEMENT_H_
