#ifndef INCLUDE_SQBOT_API_KEYBOARD_BUTTON_POLL_TYPE_H_
#define INCLUDE_SQBOT_API_KEYBOARD_BUTTON_POLL_TYPE_H_
...
#endif  // INCLUDE_SQBOT_API_KEYBOARD_BUTTON_POLL_TYPE_H_
