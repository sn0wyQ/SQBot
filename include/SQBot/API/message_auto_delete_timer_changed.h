#ifndef INCLUDE_SQBOT_API_MESSAGE_AUTO_DELETE_TIMER_CHANGED_H_
#define INCLUDE_SQBOT_API_MESSAGE_AUTO_DELETE_TIMER_CHANGED_H_
...
#endif  // INCLUDE_SQBOT_API_MESSAGE_AUTO_DELETE_TIMER_CHANGED_H_
