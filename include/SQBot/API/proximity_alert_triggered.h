#ifndef INCLUDE_SQBOT_API_PROXIMITY_ALERT_TRIGGERED_H_
#define INCLUDE_SQBOT_API_PROXIMITY_ALERT_TRIGGERED_H_
...
#endif  // INCLUDE_SQBOT_API_PROXIMITY_ALERT_TRIGGERED_H_
